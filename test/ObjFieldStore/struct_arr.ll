...
; CHECK: [ValueProf] | %struct.foo = type { %struct.foo* } | %struct.foo* | {{0x[0-9a-f]*}} | 0 | 0 | {{0x0|[(]nil[)]}}
; CHECK-NEXT: [ValueProf] | %struct.foo* | %struct.foo* | {{0x[0-9a-f]*}} | 2 | {{0x0|[(]nil[)]}}
; CHECK-NEXT: ValueProf] | [3 x %struct.foo*] | %struct.foo* | {{0x[0-9a-f]*}} | 0 | 2 | {{0x0|[(]nil[)]}}
